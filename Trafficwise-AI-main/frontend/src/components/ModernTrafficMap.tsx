  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <Card className="overflow-hidden" glow>
        <div className="relative h-80 bg-gradient-to-br from-blue-100 to-green-100 dark:from-slate-900/20 dark:to-green-900/20">
          {/* Map Placeholder */}
            ...
            <div className="space-y-3">
              {currentCityData.routes.map((route, index) => (
                <motion.div
                  ...
                  className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/60 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700/60 transition-colors"
                >
                  <div className="flex items-center space-x-3">
