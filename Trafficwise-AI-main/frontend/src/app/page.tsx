    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <section className="relative overflow-hidden px-6 py-24 sm:py-32">
        <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          >
            <defs>
              <pattern id="hero-pattern" width="200" height="200" patternUnits="userSpaceOnUse">
        ...
        <div className="mx-auto max-w-7xl">
          <motion.div className="mx-auto max-w-4xl text-center" initial="initial" animate="animate" variants={stagger}>
            ...
            <motion.p className="mt-8 text-xl leading-8 text-slate-600 dark:text-slate-400" variants={fadeInUp}>
              Transform your city's mobility with AI-powered traffic intelligence. Make data-driven decisions for
              smarter urban planning and optimized transportation systems.
            </motion.p>
      ...
      <section className="py-24 px-6 bg-slate-900 dark:bg-slate-950">
        <div className="mx-auto max-w-7xl">
          <motion.div
            ...
            variants={fadeInUp}
          >
            <h2 className="text-4xl font-bold text-white mb-4">Trusted by Cities Worldwide</h2>
      ...
      <section className="py-24 px-6">
        <div className="mx-auto max-w-4xl text-center">
          <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={stagger}>
            <motion.h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-6" variants={fadeInUp}>
              Ready to Transform Your City's Traffic?
            </motion.h2>

            <motion.p className="text-xl text-slate-600 dark:text-slate-400 mb-12" variants={fadeInUp}>
      ...
      {/* Demo Modal */}
      <Modal isOpen={showDemo} onClose={() => setShowDemo(false)} title="TrafficWise Demo">
        <div className="p-6">
